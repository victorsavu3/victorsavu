...
More than 5 years ago, I moved away from music streaming services to my own self-hosted solution. In this blog post I document my setup both for myself and for anyone looking for inspiration on how to get started or how to manage a sizable collection.
...
There are many more lossy music formats and I also use them. The most popular lossy format, [MP3], is supported by pretty much everything. My current favorite format, [Opus][^opus], was only released in 2012 and is still evolving. I already use both formats and like that I can re-encode my music without loss. 

## Where I get my music

> [!NOTE]
> **TL;DR:** CDs are usually cheaper. Look at:
> 1. [Amazon] (CDs)
> 1. [medimops] (Used CDs)
> 1. [Qobuz] (Digital downloads)
> 1. [Bandcamp] (Digital downloads)
...
To get going, I found a few boxes of used CDs on [eBay] (they even have a category for it). That gave me a great starting point for my setup while not being that expensive. I spent less than €100 to get a few hundred hours of music.

### How it's going

To always have "new" music, I budget €20 every month to buy music. It is more expensive than a streaming subscription, but I do get to keep all of my music forever. I have a running wishlist of tracks and albums and pick things from there that fit into the budget. Most of the time, I pick something that's on sale.

My main sources of music are now:

<ol>
    <li>
        <a href="https://www.amazon.de/-/en/gp/browse.html?node=255882" rel="external">Amazon</a> (CDs)
        <ul>
            <li>My main source of recent CD releases</li>
            <li class="positive">Great selection, always has popular recent releases</li>
            <li class="positive">Lets you download well-tagged flac files</li>
            <li class="negative">Prices are sometimes inflated</li>
        </ul>
    </li>
    <li>
        <a href="https://www.qobuz.com/de-de/shop" rel="external">Qobuz</a> (Digital downloads)
        <ul>
            <li>My main source of lossless digital music</li>
            <li class="positive">Great selection, most releases can be found here (old and new)</li>
            <li class="positive">A wishlist can help find deals</li>
            <li class="negative">Almost always more expensive than CDs</li>
            <li class="negative">Higher-quality releases are even more expensive</li>
        </ul>
    </li>
    <li>
        <a href="https://www.medimops.de/musik-C0255882/" rel="external">medimops</a> (Used CDs)
        <ul>
            <li>My main source of used CDs (mostly older releases that are hard to find new)</li>
            <li>Often the seller of used CDs on Amazon, so ordering directly is cheaper</li>
            <li class="negative">
                CDs are used
                <ul>
                    <li>CD quality is not always guaranteed. I haven't had completely unreadable disks yet, but some were a struggle to rip.</li>
                </ul>
            </li>
        </ul>
    </li>
    <li>
        <a href="https://bandcamp.com/" rel="external">Bandcamp</a> (Digital downloads)
        <ul>
            <li>Smaller bands just release their music on Bandcamp and it's definitely the right place to get it</li>
            <li class="positive">Pay artists directly</li>
            <li class="positive">Amazing prices</li>
            <li class="negative">Can't find most well-known bands and artists here</li>
        </ul>
    </li>
</ol>
...
To help with this, I created my own tool, [subsonic-duplicates], to deal with it. It finds duplicates using heuristics based on tags and lets me choose the canonical version. Matches can also be added manually (sometimes tracks have completely different names in different albums). Unless you want the same flexibility I do when dealing with duplicates, you should try to find something else.
...
If file size or bandwidth is a concern, Navidrome can convert files on the fly. I managed to listen to music on my phone using [Opus] while using amazingly little data.

## Playing music

[Navidrome] is available from anywhere and can play music via an [OpenSubsonic] client or the website itself. 
...
To go old-school, I also own a [HiBy R3 II][^hiby] (pre-2025) to have a distraction-free music experience on the go. It works great, but synchronizing music is a pain and it's impossible to track scrobbles. If I ever get the chance, I want to get [Rockbox] running on a device again (I used it many moons ago) and set up a sync from its `.scrobbler.log` to [Navidrome].
...
[^hiby]: The [original HiBy R3 II page] is no longer available.
...
[original HiBy R3 II page]: https://store.hiby.com/products/hiby-r3-ii?variant=43922642534616
